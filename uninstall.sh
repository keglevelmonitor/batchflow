#!/bin/bash
# uninstall.sh
# Uninstallation script for BatchFlow

APP_DIR="$HOME/batchflow"
DATA_DIR="$HOME/batchflow-data"
DESKTOP_FILE="$HOME/.local/share/applications/batchflow.desktop"
...
if [ "$choice" == "APP" ]; then
    TO_DELETE="$APP_DIR"
    MSG="The BatchFlow application folder."
elif [ "$choice" == "ALL" ]; then
    TO_DELETE="$APP_DIR and $DATA_DIR"
    MSG="The BatchFlow application AND all user data/settings."
else
